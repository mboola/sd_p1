...
def wait_for_stop_signal(stop_event, lambda_id, connection):
...
def consume_insults(stop_event, connection, redis_server):
    channel = connection.channel()
...
def lambda_handler(event, context):
    ...
    threading.Thread(target=wait_for_stop_signal, args=(stop_event, lambda_id, connection,)).start()

    consume_insults(stop_event, connection, redis_server)
