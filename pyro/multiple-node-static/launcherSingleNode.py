...
def main():
    ...
    try:
        ...
        processes.append(launch("Client InsultService", f"python3 {BASE_DIR}/InsultService/client.py"))

        # 7. Client InsultFilterService
        processes.append(launch("Client InsultFilterService", f"python3 {BASE_DIR}/InsultFilterService/client.py"))
